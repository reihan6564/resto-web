...
$pdf->Ln(7);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(95, 6, 'Data Penjualan Per -Bulan ', 0,  1, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(0, 7, $hasil, 0,  1, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(8, 6, 'ID', 1, 0);
...
$mahasiswa = $this->db->query("SELECT * FROM tb_detail_pesan WHERE waktu_pesanan LIKE '$hasil%'")->result();
